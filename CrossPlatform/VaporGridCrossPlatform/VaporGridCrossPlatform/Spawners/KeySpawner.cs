...
namespace VaporGridCrossPlatform.Spawners
{
    public class KeySpawner : Spawner
    {
        ...
        public KeySpawner(Game game, GridManager gm, RhythmManager rm,  Camera camera, Player p, int numberOfObjects, int spawnBuffer) : base(game, gm, rm,  camera, p, numberOfObjects, spawnBuffer)
        {
